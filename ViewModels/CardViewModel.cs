...
{ 
    public partial class CardViewModel : ObservableObject
    {
        ...
        private readonly Func<string, Task<bool>>? _confirmAction;
        private bool _isDropIndicatorAtEnd;
        ...
        public bool IsDropIndicatorAtEnd
        {
            get => _isDropIndicatorAtEnd;
            set => SetProperty(ref _isDropIndicatorAtEnd, value);
        }
        public CardViewModel(Card card, DataService dataService, Action refreshParent,
            Func<string, Task<bool>>? confirmAction = null, Func<string, CardViewModel?>? findCardById = null)
        {
            _card = card;
        ...
        private async Task Delete()
        {
            ...
            {
                if (_confirmAction != null && !await _confirmAction("Delete this card?"))
                    return;
            }
        ...
        {
            var text = EditTitleText.Trim();
            if (!string.IsNullOrEmpty(text) && text != Title)
            {
                _dataService.UpdateCard(_card.Id, title: text);
            }
        ...
        private void AddNote()
        {
            ...
            // Stay open for rapid note entry — user closes with Escape or clicking outside
            RefreshNotes();
        }
